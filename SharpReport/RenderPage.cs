...
namespace SharpReport
{
	internal class RenderPage {
		/// <summary>
		/// Elementos para ser renderizados en esta página
		/// </summary>
		private readonly List<RenderElement> m_lstRender = new List<RenderElement>();

		internal List<RenderElement> LstRender => m_lstRender;
	}
}